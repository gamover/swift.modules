...
Module.prototype.setPathToModule = function setPathToModule (pathToModule)
{
    if (this._isRun) throw new ModuleError()
        ...
        .setCode(ModuleError.codes.MODULE_ALREADY_RUN);
    if (typeof pathToModule !== 'string' || !pathToModule.length) throw new ModuleError()
    ...
    if (!$swiftUtils.fs.existsSync(pathToModule) || !$fs.statSync(pathToModule).isDirectory()) throw new ModuleError()
...
Module.prototype.setPathToModels = function setPathToModels (pathToModels)
{
    if (this._isRun) throw new ModuleError()
        ...
        .setCode(ModuleError.codes.MODULE_ALREADY_RUN);
    if (typeof pathToModels !== 'string' || !pathToModels.length) throw new ModuleError()
    ...
    if (!$swiftUtils.fs.existsSync(pathToModels) || !$fs.statSync(pathToModels).isDirectory()) throw new ModuleError()
...
Module.prototype.setPathToViews = function setPathToViews (pathToViews)
{
    if (this._isRun) throw new ModuleError()
        ...
        .setCode(ModuleError.codes.MODULE_ALREADY_RUN);
    if (typeof pathToViews !== 'string' || !pathToViews.length) throw new ModuleError()
    ...
    if (!$swiftUtils.fs.existsSync(pathToViews) || !$fs.statSync(pathToViews).isDirectory()) throw new ModuleError()
...
Module.prototype.setPathToControllers = function setPathToControllers (pathToControllers)
{
    if (this._isRun) throw new ModuleError()
        ...
        .setCode(ModuleError.codes.MODULE_ALREADY_RUN);
    if (typeof pathToControllers !== 'string' || !pathToControllers.length) throw new ModuleError()
...
{
    if (!(requestListener instanceof Object)) throw new ModuleError()
...
Module.prototype.setRoutes = function setRoutes (routes)
{
    if (this._isRun) throw new ModuleError()
        ...
        .setCode(ModuleError.codes.MODULE_ALREADY_RUN);
    if (!$swiftUtils.type.isObject(routes)) throw new ModuleError()
...
Module.prototype.addRoute = function addRoute (controllerName, actionName, path)
{
    if (this._isRun) throw new ModuleError()
        ...
        .setCode(ModuleError.codes.MODULE_ALREADY_RUN);
    if (typeof controllerName !== 'string' || !controllerName.length) throw new ModuleError()
    ...
    if (typeof actionName !== 'string' || !actionName.length) throw new ModuleError()
    ...
    if (typeof path !== 'string' || !path.length) throw new ModuleError()
